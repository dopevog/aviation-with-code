const GitHub = class{
    static inject(domElement){
        ...
        const link = '   <a href="https://github.com/dopevog/aviation-with-code" class="github-corner" aria-label="View source on GitHub">  '  + 
        ...
        linkEl.setAttribute('herf', 'https://github.com/dopevog/gamepad.js')
